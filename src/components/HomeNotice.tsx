    ...
    >
      ...
      <div className="relative w-full max-w-xl rounded-2xl border border-white/15 bg-white/[0.06] backdrop-blur-xl shadow-2xl ring-1 ring-white/10 p-6 md:p-7 animate-scale-in">
        <button
          ...
          className="absolute right-3 top-3 rounded-full p-2 text-white/70 hover:bg-red/80 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
        >
          ×
        </button>
        ...
        <div className="space-y-3.5">
          ...
          <p id="venusa-notice-desc" className="text-white/80 font-body font-light leading-relaxed">
            The website is currently <span className="font-medium text-white">under development</span>.
            You can still explore and experience the journey of <span className="font-medium text-white">VENUSA</span>.
          </p>
