...
const toggleMobile = (k: keyof typeof mExpand) =>
  ...
  const scheduleClose = () => {
    ...
    }, 160) // small delay gives time to travel to panel
  }
  ...
  return (
    <header className="fixed top-0 z-50 w-full border-b border-black/10 bg-white/90 backdrop-blur">
      ...
      >
        <div className={["transition-all duration-200 ease-in-out", openKey ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-1"].join(" ")}>
